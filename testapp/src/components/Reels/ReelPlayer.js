  ...
  return (
    <div className='h-full bg-white/20 relative rounded-md overflow-hidden'>
      <div className="h-full flex items-end">
        ...
        <div className="flex items-center absolute bottom-4 left-2 z-20">
        ...
        <div className='w-full h-full before:w-full before:absolute before:bg-gradient-to-t before:from-black/40 before:via-transparent before:z-10 before:h-full'>
